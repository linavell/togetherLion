...
public class Naver_Sens_V2 
{
	...
	public void send_msg(String tel, String rand) 
	{
		...
		String accessKey = "6Nhv3uRwx9drN1CNGxyK";                    	 	// 네이버 클라우드 플랫폼 회원에게 발급되는 개인 인증키
		String secretKey = "oKO1R1CfAh5zj7194QELezJMVuER045x9tt0auZa"; 	 	// 2차 인증을 위해 서비스마다 할당되는 service secret
		String serviceId = "ncp:sms:kr:288884082054:sms";        		// 프로젝트에 할당된 SMS 서비스 ID
	    ...
	    bodyJson.put("from","01038633964");									// 발신번호 * 사전에 인증/등록된 번호만 사용할 수 있습니다.		
